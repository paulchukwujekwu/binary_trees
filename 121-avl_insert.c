...
/**
 * balance - This will measure the balance factor of a binary tree.
...
/**
 * avl_insert_recursive - This inserts a value into an AVL tree
 *                        recursively.
...
/**
 * avl_insert - This will insert a value into an AVL tree.
